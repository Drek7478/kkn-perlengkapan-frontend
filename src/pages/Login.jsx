  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-slate-50 dark:bg-gray-950 transition-colors duration-300 overflow-hidden kkn-safe-bottom">
      ...
      >
        ...
        <div className="absolute -top-24 -right-24 w-80 h-80 rounded-full kkn-float-a kkn-fade-in kkn-d-0"
          style={{ background: 'radial-gradient(circle, rgba(255,255,255,0.12) 0%, transparent 70%)' }} />
        <div className="absolute -bottom-20 -left-20 w-64 h-64 rounded-full kkn-float-b kkn-d-f2 kkn-fade-in kkn-d-1"
          style={{ background: 'radial-gradient(circle, rgba(167,139,250,0.18) 0%, transparent 70%)' }} />
        <div className="absolute top-1/2 -translate-y-1/2 right-8 w-28 h-28 rounded-full kkn-float-c kkn-d-f3 kkn-fade-in kkn-d-2"
          style={{ background: 'radial-gradient(circle, rgba(96,165,250,0.15) 0%, transparent 70%)' }} />
        <div className="absolute top-1/4 left-12 w-16 h-16 rounded-full kkn-float-d kkn-d-f4 kkn-fade-in kkn-d-1"
          style={{ background: 'radial-gradient(circle, rgba(255,255,255,0.1) 0%, transparent 70%)' }} />
        <div className="absolute bottom-1/4 right-1/3 w-10 h-10 rounded-full kkn-float-a kkn-d-f1 kkn-fade-in kkn-d-3"
        ...
        <div className="relative z-10 space-y-4">
          ...
          {/* Heading Besar — Reveal up (t=0.5s) */}
          <h1 className="kkn-reveal-up kkn-d-5">
            ...
            <span className="block text-4xl font-bold leading-tight" style={{ color: '#93c5fd' }}>KKN</span>
            <span className="block text-4xl font-bold text-white leading-tight">dengan Mudah</span>
          </h1>

          {/* Subtitle — Reveal up (t=0.7s) */}
        ...
        {/* DAFTAR FITUR — Bounce dari kiri satu per satu (t=0.9s, 1.1s, 1.3s) */}
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <div className="flex-1 flex flex-col lg:items-center lg:justify-center lg:px-12 lg:py-12 lg:bg-slate-50 dark:lg:bg-gray-950">
        
        {/* ============================================================
            HERO MOBILE — Hanya tampil di mobile (lg:hidden)
            ============================================================ */}
        <div className="lg:hidden kkn-hero-mobile px-6 pt-12 pb-16 relative">
          {/* ORB dekoratif untuk hero mobile */}
          <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full pointer-events-none kkn-float-a kkn-d-f1"
            style={{ background: 'radial-gradient(circle, rgba(255,255,255,0.08) 0%, transparent 70%)' }} />
          <div className="absolute -bottom-8 -left-8 w-32 h-32 rounded-full pointer-events-none kkn-float-b"
            style={{ background: 'radial-gradient(circle, rgba(167,139,250,0.12) 0%, transparent 70%)' }} />
          <div className="absolute top-1/3 right-4 w-16 h-16 rounded-full pointer-events-none kkn-float-c kkn-d-f3"
          ...
          <div className="relative z-10">
            ...
            <div className="kkn-reveal-up kkn-d-3">
              ...
              <h1 className="text-2xl font-bold text-white leading-snug">
                Kelola Perlengkapan <span style={{ color: '#93c5fd' }}>KKN</span>
              </h1>
            </div>
        ...
        {/* ============================================================
            CARD FORM LOGIN
            Mobile: Bottom sheet overlap di atas hero
            Desktop: Card biasa di tengah
            ============================================================ */}
        <div className={`
          w-full max-w-md
          bg-white dark:bg-gray-900
          p-7 sm:p-8
          kkn-card-entrance kkn-d-3
          lg:rounded-3xl lg:border lg:border-gray-100/80 dark:lg:border-gray-800
          lg:shadow-2xl lg:shadow-gray-200/60 dark:lg:shadow-none
          ${/* Mobile bottom sheet style */}
          'kkn-bottom-sheet lg:rounded-3xl lg:border lg:border-gray-100/80 dark:lg:border-gray-800'
        `.replace(/\s+/g, ' ')}
        >
          {/* Toggle Dark Mode — Desktop only (mobile sudah di hero) */}
          ...
          {errors.email && (
            <div className="mb-5 flex items-start gap-3 rounded-xl px-4 py-3 bg-red-50 dark:bg-red-950/40 border border-red-100 dark:border-red-900/50 kkn-slide-down kkn-d-0">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {/* FIELD EMAIL — Reveal up + Icon Mail */}
            <div className="kkn-reveal-up kkn-d-7">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoComplete="email"
                  autoFocus
                  className={`kkn-input-glow w-full pl-10 pr-4 py-3.5 rounded-xl text-sm bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-300 dark:placeholder-gray-600 border transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-500 ${
            ...
            {/* FIELD PASSWORD — Reveal up + Icon Lock */}
            <div className="kkn-reveal-up kkn-d-8">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`kkn-input-glow w-full pl-10 pr-14 py-3.5 rounded-xl text-sm bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-300 dark:placeholder-gray-600 border transition-all duration-200 hover:border-gray-300 dark:hover:border-gray-500 ${
            ...
            {/* TOMBOL SUBMIT — Reveal up + Shimmer */}
            <div className="kkn-reveal-up kkn-d-9 pt-1">
              <button
                ...
                style={{ background: 'linear-gradient(135deg, #2563eb 0%, #4f46e5 50%, #7c3aed 100%)', boxShadow: '0 4px 24px rgba(79, 70, 229, 0.35)' }}>
                {loading ? (
                  <>
          ...
          {/* FOOTER BADGE "ADMIN ONLY" — Reveal up */}
        ...
        {/* Spacer bawah untuk safe area notch */}
