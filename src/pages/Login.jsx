  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-slate-50 dark:bg-gray-950 transition-colors duration-300 overflow-hidden kkn-safe-bottom">
      ...
      >
        ...
        <div
          className="absolute -top-24 -right-24 w-80 h-80 rounded-full kkn-float-a kkn-fade-in kkn-d-0 blur-3xl"
          style={{ background: 'radial-gradient(circle, rgba(255,255,255,0.15) 0%, transparent 70%)' }}
        />
        <div
          className="absolute -bottom-20 -left-20 w-64 h-64 rounded-full kkn-float-b kkn-d-f2 kkn-fade-in kkn-d-1 blur-3xl"
          style={{ background: 'radial-gradient(circle, rgba(167,139,250,0.2) 0%, transparent 70%)' }}
        />
        <div
          className="absolute top-1/2 -translate-y-1/2 right-8 w-28 h-28 rounded-full kkn-float-c kkn-d-f3 kkn-fade-in kkn-d-2 blur-2xl"
          style={{ background: 'radial-gradient(circle, rgba(96,165,250,0.18) 0%, transparent 70%)' }}
        />
        <div
          className="absolute top-1/4 left-12 w-20 h-20 rounded-full kkn-float-d kkn-d-f4 kkn-fade-in kkn-d-1 blur-2xl"
          style={{ background: 'radial-gradient(circle, rgba(255,255,255,0.1) 0%, transparent 70%)' }}
        />
        <div
          className="absolute bottom-1/3 right-1/4 w-14 h-14 rounded-full kkn-float-a kkn-d-f1 kkn-fade-in kkn-d-3 blur-xl"
        ...
        <div className="relative z-10 space-y-4">
          ...
          <h1 className="kkn-reveal-up kkn-d-5">
            ...
            <span className="block text-4xl font-bold leading-tight kkn-text-gradient">
              KKN
            </span>
            <span className="block text-4xl font-bold text-white leading-tight">
              dengan Mudah
        ...
        <div className="relative z-10 space-y-3">
          {/* Fitur 1 — delay 0.9s */}
          <div
            className="flex items-center gap-3 rounded-xl px-4 py-3 kkn-bounce-left kkn-d-9"
            style={{
          ...
          {/* Fitur 2 — delay 1.1s */}
          <div
            className="flex items-center gap-3 rounded-xl px-4 py-3 kkn-bounce-left kkn-d-11"
            style={{
              background: 'rgba(255,255,255,0.08)',
              border: '1px solid rgba(255,255,255,0.12)',
              backdropFilter: 'blur(4px)',
          ...
          {/* Fitur 3 — delay 1.3s */}
          <div
            className="flex items-center gap-3 rounded-xl px-4 py-3 kkn-bounce-left kkn-d-13"
            style={{
              background: 'rgba(255,255,255,0.08)',
              border: '1px solid rgba(255,255,255,0.12)',
              backdropFilter: 'blur(4px)',
      ...
      <div className="flex flex-col lg:flex-1 lg:items-center lg:justify-center lg:px-12 lg:py-12 relative kkn-bg-right">
        ...
        />
        <div
          className="hidden lg:block absolute -bottom-24 -left-16 w-64 h-64 rounded-full blur-3xl pointer-events-none"
          style={{ background: 'radial-gradient(circle, rgba(59,130,246,0.1) 0%, transparent 70%)' }}
        />
        <div
          className="hidden lg:block absolute top-1/3 left-1/4 w-40 h-40 rounded-full blur-3xl pointer-events-none"
        ...
        <div className="lg:hidden kkn-hero-mobile px-6 pt-12 pb-16 relative">
          ...
          <div
            className="absolute -top-10 -right-10 w-40 h-40 rounded-full pointer-events-none kkn-float-a kkn-d-f1 blur-2xl"
            style={{ background: 'radial-gradient(circle, rgba(255,255,255,0.1) 0%, transparent 70%)' }}
          />
          <div
            className="absolute -bottom-8 -left-8 w-36 h-36 rounded-full pointer-events-none kkn-float-b blur-2xl"
            style={{ background: 'radial-gradient(circle, rgba(167,139,250,0.15) 0%, transparent 70%)' }}
          />
          <div
            className="absolute top-1/3 right-4 w-20 h-20 rounded-full pointer-events-none kkn-float-c kkn-d-f3 blur-xl"
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-2.5 kkn-pop-in kkn-d-1">
                <div
                  className="w-9 h-9 rounded-xl flex items-center justify-center kkn-logo-pulse"
                  style={{
                    background: 'rgba(255,255,255,0.18)',
                    border: '1px solid rgba(255,255,255,0.3)',
                  }}
            ...
            <div className="kkn-reveal-up kkn-d-3">
              ...
              <h1 className="text-2xl font-bold text-white leading-snug">
                Kelola Perlengkapan{' '}
                <span className="kkn-text-gradient">KKN</span>
              </h1>
            </div>

            {/* Ikon Fitur Ringkas Horizontal — STATIS */}
            <div className="flex items-center gap-3 mt-5 kkn-reveal-up kkn-d-5">
              <div className="flex items-center gap-1.5" style={{ color: 'rgba(255,255,255,0.7)' }}>
                ...
                <span className="text-xs whitespace-nowrap">Inventaris</span>
              </div>
              <div className="flex items-center gap-1.5" style={{ color: 'rgba(255,255,255,0.7)' }}>
                <Search size={14} />
                <span className="text-xs whitespace-nowrap">Inspeksi</span>
              </div>
              <div className="flex items-center gap-1.5" style={{ color: 'rgba(255,255,255,0.7)' }}>
                <BarChart3 size={14} />
                <span className="text-xs whitespace-nowrap">Laporan</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          {/* HEADER CARD — Ikon + Judul + Subtitle — DIPERBAIKI: text-center tanpa pl-4 */}
          <div className="text-center mb-8">
            {/* Ikon Package — Pop in + Pulse terus */}
            <div className="kkn-pop-in kkn-d-4 flex justify-center mb-5">
              <div
                className="w-16 h-16 rounded-2xl flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/60 dark:to-indigo-950/60 kkn-logo-pulse"
